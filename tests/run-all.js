...
const tests = [
    ...
    'auth.test.js',
    'client-reconnect-options.test.js',
    'reconnect-state.test.js',
    'backoff.test.js',
    'latency-sampler.test.js',
    'latency-ping.test.js',
    'safe-emitter.test.js',
    'df-parse.test.js',
    'health-server.test.js',
    'chat-ack.test.js',
    'task-result-ack.test.js',
    'agent-hello-ack.test.js',
    'shutdown-confirm.test.js',
    'socket-error-boundary.test.js',
    'shell-routing.test.js',
    'shell-manager.test.js',
    'shell-manager-pty.test.js',
    'shell-output-chat.test.js',
    'shell-buffer-flush-on-stop.test.js',
    'shells-list.test.js',
    'redirection-to-chat.test.js',
    'offline-outbox.test.js',
    'offline-outbox-retry.test.js',
    'broadcast.test.js',
    'rooms.test.js',
    'warden.test.js',
    'delivery.test.js',
    'offline-queue-persist.test.js',
    'safety.test.js',
    'audit-metrics.test.js',
    'tenant.test.js',
    // v3.5 feature tests (combined)
    'v3.5-feature-tests.js',
    'load-connections.test.js',
];
